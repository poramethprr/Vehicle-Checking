...
import { UserIcon, PhoneIcon, LockClosedIcon, ExclamationCircleIcon, CheckCircleIcon, ShieldCheckIcon, KeyIcon, EyeIcon, EyeSlashIcon } from '@heroicons/vue/24/outline'
